...
ns.StyleCaptions = {
	...
	grid = "Every totem of every element stays visible in rows. Click one to drop it; the assigned one is highlighted and the dropped one carries the timer. Split by Element (Mode & Twisting) gives each row its own frame.",
