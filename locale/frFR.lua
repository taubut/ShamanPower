...
L["Totem Assignments Scale"] = "Échelle de la fenêtre d'affectation des totems"
L["Borders"] = "Bordures"
...
L["This allows you to adjust the overall size of the Totem Assignments Panel"] = "Cela vous permet d'ajuster la taille globale du panneau des affectations de totems"
